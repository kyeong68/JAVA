...
public class Ex00Basic {
	...
	public static void main(String[] args) {
		...
		// 이를 8bit 까지 쓰게 하려다보니 ANSI체계로 256개의 문자와 대응하게 만들었는데,
		...
		long world_Human = 7000000000l;//L
		
		// float 타입
		// 실수형
		// 크기 : 4byte
		// 특징 -> 부동소수점방식을 사용한다. (bit를 지수부와 가수부로 나누어져사용해서 범위가 엄청 크다)
		...
		// 자동형변환(묵시적형변환) / 강제형변환(명시적형변환)
		
		// 묵시적 형변환
		// 등호를 기준으로 타입이 일치하지 않을 때
		// 이때 자바의 컴파일러가 알아서 작은타입을 큰 타입으로 자동 변환 시켜주는 것.
		double tenPi = 3.14*10; // 3.14 곱하기 10에서 10이 실수연산을 위해서 10.0이 된다.
		...
		//Scanner (입력을 하기위한 도구)
		//System.in.read를 사용하면 출력을 ASCII코드에 맞춰 바꿔줘야했음.
